...
INSERT INTO files (name, description, size, path, directory_id, config, parse, "ADC", "RAD", "RA", "AD", "RD", spectrogram, "radarPC", "lidarPC", image, depth_image, labeled) VALUES ('RECORD@2020-11-22_12.48.07.zip', 'description', '120GB', '/home/kangle/dataset/radial/ready-to-use',7, '', 'RADIal', FALSE, FALSE, FALSE, FALSE, TRUE, FALSE, TRUE, TRUE, TRUE, FALSE, TRUE);
