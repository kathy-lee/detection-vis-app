...
model_zoo = ["Choose a model type", "FFTRadNet", "RODNet", "RECORD", "RECORDNoLstm", "RECORDNoLstmMulti", "MVRECORD"]   # This will be changed when streamlit support selectbox with None as default option
